public class ArrayBidimensional {
    public static void main (String[] args) {
        ...
        matriz[0][0] = 120; matriz[1][0] = 232; matriz[2][0] = 201; matriz[3][0] = 304; matriz[4][0] = 405;
        matriz[0][1] = 120; matriz[1][1] = 232; matriz[2][1] = 201; matriz[3][1] = 304; matriz[4][1] = 405;
        matriz[0][2] = 120; matriz[1][2] = 232; matriz[2][2] = 201; matriz[3][2] = 304; matriz[4][2] = 405;
        matriz[0][3] = 120; matriz[1][3] = 232; matriz[2][3] = 201; matriz[3][3] = 304; matriz[4][3] = 405;
        matriz[0][4] = 120; matriz[1][4] = 232; matriz[2][4] = 201; matriz[3][4] = 304; matriz[4][4] = 405;
