...
public class ExemploEnum {
    public static void main(String[] args) {
        ...
        try {
            ...
            switch (dia) {
                case SEGUNDA:
                    System.out.println("N1 - Banco de Dados");
                break;
                case TERCA:
                    System.out.println("N1 - Algoritmos e Estrutura de Dados I");
                break;
                case QUARTA:
                    System.out.println("N1 - Metodologias Ágeis/Usabilidade de Software");
                break;
                case QUINTA:
                    System.out.println("N1 - Pesquisa Operacional");
                    break;
                case SEXTA:
                    System.out.println("N1 - Fabrica de Software I");
                    break;
                case SABADO:
                case DOMINGO:
